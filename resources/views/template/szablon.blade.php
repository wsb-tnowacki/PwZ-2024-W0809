...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>W0809 - @yield('tytul', 'WSB')</title>
    ...
    <body class="antialiased">
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
                                ...
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                      Witaj na stronie <b>{{ Auth::user()->name }}</b>
                                    </a>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8 w-100">
                ...
                <div class="mt-16 w-100">
                    <div class="grid grid-cols-1  gap-6 lg:gap-8 w-100">
                        <div class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500 w-100">
                            <div style="w-100">
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 w-100">@yield('podtytul', 'Start')</h2>
